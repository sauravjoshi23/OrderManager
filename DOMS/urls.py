...
urlpatterns = [
    ...
    url(r'^customers$', my_order.index1, name='home1'),
    ...
    url(r'^users/login/$', auth.LoginView, {'template_name': 'login.html'}, name='login'),
    url(r'^users/logout/$', auth.LogoutView, {'next_page': '/'}, name='logout'),
    url(r'^users/change_password/$', login_required(auth.PasswordResetForm), {'post_change_redirect' : 'login/','template_name': 'change_password.html'}, name='change_password'),
]
